...
export const PROJECTS : Project[] = [
    ...
    },
    {
        ...
        image: "biome.png",
        details: "Created with four other students, Biome is a video game where the goal is to get from the center of a procedurally generated world to the outer rim, all while battling a series of increasingly challenging enemies. The game is still in development."
    },
    {
